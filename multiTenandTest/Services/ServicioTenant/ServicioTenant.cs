...
namespace multiTenandTest.Services
{
    public class ServicioTenant : IServicioTenant
    {
        ...
        public string ObtenerTenant()
        {
            ...
            var claimTenant = authTicket.Principal.Claims.FirstOrDefault(x =>
                x.Type == Constants.ClaimTenantId
            );
        ...
        {
            var opt = httpContext
                .RequestServices.GetRequiredService<IOptionsMonitor<CookieAuthenticationOptions>>()
